...
export default function WaveBorderGreen() {
  ...
  return (
    <div className="relative z-20 w-full min-h-screen bg-lime-400 overflow-hidden">
      {/* Wave container */}
      <div className="absolute top-0 left-0 w-full h-16 overflow-hidden">
        <svg
          ref={waveRef}
          className="block w-[200%] h-full bg-lime-400"
