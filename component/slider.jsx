            ...
            >
                ...
                <div
                    ...
                    <div className="text-center px-5">
                        <h1 className="first text-9xl">FUN</h1>
                        <h1 className="first text-9xl">ACTIVITY</h1>
                    </div>
                </div>
                ...
                <div className=" flex-shrink-0 w-screen h-screen flex items-center justify-center">
                    <div className="p-10 flex flex-col items-center justify-center text-black">
                        <h2 className="second text-4xl">Solo Dance</h2>
                        <h2 className="first font-medium text-8xl">Boy</h2>
                        <img className='w-[280px] aspect-square object-center object-cover' src="/soloboydance.gif" alt="" />
                    </div>
                </div>
                ...
                <div className=" flex-shrink-0 w-screen h-screen flex items-center justify-center">
                    <div className="p-10 flex flex-col items-center justify-center text-black">
                        <h2 className="second text-4xl">Solo Dance</h2>
                        <h2 className="first font-medium text-8xl">Girl</h2>
                        <img className='h-[230px] aspect-square object-center object-contain' src="/sologirldance.gif" alt="" />
                    </div>
                </div>
                ...
                <div className=" flex-shrink-0 w-screen h-screen flex items-center justify-center">
                    <div className="p-10 flex flex-col items-center justify-center text-black">
                        {/* <h2 className="second text-4xl">Singing</h2> */}
                        <h2 className="first font-medium text-8xl">Group Dance</h2>
                        <img className='h-[230px] aspect-square object-center object-contain bg-white rounded-xl' src="/groupdance.gif" alt="" />
                    </div>
                </div>
                ...
                <div className="flex-shrink-0 w-screen h-screen flex items-center justify-center">
                    <div className="p-10 flex flex-col items-center justify-center text-black">
                        {/* <h2 className="second text-4xl">Singing</h2> */}
                        <h2 className="first font-medium text-8xl">Singing</h2>
                        <img className='h-[230px] aspect-square object-center object-contain' src="/singing.gif" alt="" />
                    </div>
                </div>
            </div>
